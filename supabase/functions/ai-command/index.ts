...
const TOOLS = [
  ...
  { name: 'createConnector', description: 'Create connector between two objects.', input_schema: { type: 'object' as const, properties: { fromId: { type: 'string' }, toId: { type: 'string' }, style: { type: 'string', enum: ['arrow', 'line', 'dashed', 'dotted'] }, color: { type: 'string' } }, required: ['fromId', 'toId'] } },
